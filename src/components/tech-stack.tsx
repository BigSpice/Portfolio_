...
const techStack: TechCategory[] = [
  {
    name: "Software",
    items: [
      { name: "Blender ", category: "3D Design and Concepts" },
      { name: "Fusion 360", category: "CAD" },
      { name: "AWS", category: "Database Management" },
      { name: "VxWorks", category: "Embbedded" },
      { name: "Visual Studio", category: "Programming" },
      { name: "Jetbrains Suite", category: "Programming" },
      { name: "Virtual Box", category: "Security" },
      { name: "SDR Tools", category: "Radio Comms" },
      { name: "Adobe Suite ", category: "Photography" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Assembly", category: "Programming" },
      { name: "Ruby", category: "Realtime" },
      { name: "QNX", category: "Embbedded" },
      { name: "TensorFlow ", category: "AI Engeneering" },
      { name: "Jupyter ", category: "Analysis" },
  ...
  },
  {
    name: "Hardware",
    items: [
      { name: "ESP8266", category: "Hardware" },
      { name: "ESP32", category: "Hardware" },
      { name: "STM32 ", category: "Automation" },
      { name: "Raspberry Pi", category: "Hardware" },
      { name: "Waveserver", category: "Automation" },
      { name: "IDA", category: "Reverse Eng" },
      { name: "Dot-Peek", category: "Reverse Eng" },
      { name: "NVIDIA Jetson ", category: "AI Engeneering" },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-20 md:mb-24 px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            My development stack for building real-world solutions
