          ...
          <div className="flex items-center space-x-8">
            {navbarLinks.map((link) => (
              ...
              >
                ...
                >
                  ...
                  {activeSection === link.url.substring(1) && (
                    <motion.div
                      ...
                      className="ml-1.5 h-1 w-1 rounded-full bg-neutral-900 dark:bg-green-500"
                      transition={{
                        type: "spring",
                        stiffness: 300,
                        damping: 30,
                ...
                {/* Animated underline */}
                <motion.div
                  className={`absolute -bottom-0 left-0 h-[1px] bg-neutral-900 dark:bg-green-500 w-full transform origin-left`}
                  initial={{ scaleX: 0 }}
                  animate={{
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {activeSection === link.url.substring(1) && (
                      <motion.div
                        ...
                        className="h-1 w-1 rounded-full bg-neutral-900 dark:bg-green-500"
                      />
                    )}
                  </div>
                </Link>
